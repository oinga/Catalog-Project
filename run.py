...
engine = create_engine('sqlite:///cuisine.db')
...
def newCuisine():
  ...
  if request.method == 'POST':
      newCuisine = Cuisine(name = request.form['name'], description =  request.form['description'])
...
def deleteCuisine(id):
  ...
  if request.method == 'POST':
    ...
    session.commit()
    return redirect(url_for('showCuisines', id = id))
  else:
    return render_template('deleteCuisine.html',cuisine = cuisineToDelete)

#Show cuisine details (need to add details)
...
#Edit a restaurant
@app.route('/cuisine/restaurant/<int:restaurant_id>/edit/', methods = ['GET', 'POST'])
...
#Delete a restaurant
@app.route('/cuisine/restaurant/<int:restaurant_id>/delete/', methods = ['GET','POST'])
...
@app.route('/cuisine/restaurant/<int:restaurant_id>/')
...
@app.route('/cuisine/restaurant/<int:restaurant_id>/menu/new/',methods=['GET','POST'])
...
#Edit a menu item
@app.route('/cuisine/restaurant/<int:restaurant_id>/menu/<int:menu_id>/edit', methods=['GET','POST'])
...
#Delete a menu item
@app.route('/cuisine/restaurant/<int:restaurant_id>/menu/<int:menu_id>/delete', methods = ['GET','POST'])
